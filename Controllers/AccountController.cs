...
{
    //to prevent anyone can access without logining
    [Authorize]
    public class AccountController : Controller
    {
        ...
        //[HttpPost]
        //public ActionResult CheckLogin(LoginViewModel x)
        //{
        //    LoginViewModel model = new LoginViewModel();
        //    if (model.Email == x.Email && model.Password == x.Password)
        //    {
        ...
        public ActionResult Register()
        {
            ...
            //if i want role doesn't appear in registerView
